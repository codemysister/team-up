...
<div class=" mt-5 mx-10 w-[800px]  bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex">
                <div>
                    <img class="w-16 h-16 mt-2 rounded-full" src="https://imagez.tmz.com/image/f7/1by1/2021/12/14/f7703994b69d48ca802df55729a2325c_xl.jpg" alt="Neil image">  
                </div>
                <div class="mt-4 ml-4">
                    ...
                    <button type="button" class="text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 ">Remove</button>
                </div>
