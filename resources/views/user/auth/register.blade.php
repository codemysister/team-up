    ...
    <section class="flex flex-col md:flex-row h-screen items-center">
        <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:my-auto md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
            <div class="w-full h-100"> 
                ...
                <p class="font-poppins">Already have an account? <span class="text-blue-600"> <a href="{{url('/login')}}" class="text-decoration-none">Sign up.</a></span> </p>
                
                <form action="{{url('/register')}}" class="mt-6" method="post">
                    @csrf
