...
<body class="bg-[#FFF5EC]">
    ...
    <div class="container mx-auto -mt-16 sm:-mt-28   md:text-2xl  lg:text-2xl">
        ...
        <h1 class="font-bold font-poppins text-center text-[#F2994A] p-3 -mt-10">We have sent a verification email to <span class="text-slate-900 font-poppins font-bold text">{{auth()->user()->email}}</span>, please check your email and complete the verification process to proceed to the next step
        </h1>
    </div>
