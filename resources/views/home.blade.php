    ...
    <div class="sm:container sm:mx-auto">
      <h1 class="px-3 sm:px-4   pt-24 sm:pt-28 xl:pt-32 sm:w-[60%]   text-4xl md:text-5xl lg:text-6xl xl:text-7xl sm:text-[40px] font-bold font-poppins text-center sm:text-left">Be a Leader or  <span class="text-orange-400">Member</span> </h1>
        ...
        <div class="mt-5 flex justify-center sm:justify-start sm:px-4 lg:pb-20 xl:pb-28">
          <button type="button" class="text-white  bg-orange-400 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center sm:text-left mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Getting Started</button>
        </div>
  ...
  <div class=" bg-[#fcfcfc] sm:bg-[#FFF5EC] w-[360px] sm:w-full  mx-auto rounded-3xl sm:rounded-none shadow-2xl sm:shadow-none mb-10 ">
    <div class="sm:flex ">
      ...
      <div class="sm:w-96   sm:-ml-20 md:-ml-10 lg:ml-5  sm:mt-10">
        ...
        <button type="button" class="text-white mx-[30%] sm:mx-4  mt-2  bg-[#F2994A] hover:bg-orange-500 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-6 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create Account</button>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="bg-[#fcfcfc] sm:sm:bg-[#FFF5EC] w-[360px] sm:w-[100%] mx-auto rounded-3xl sm:rounded-none shadow-2xl sm:shadow-none mb-10 ">
    <div class="flex sm:relative sm:container sm:mx-auto sm:overflow-hidden">
      <div class="sm:w-96 lg:w-full sm:h-auto  ">
        ...
        <button type="button" class="text-white mx-[30%] sm:mx-4 md:px-2 mt-2 lg:mb-32  bg-[#F2994A] hover:bg-orange-500 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-6 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create Account</button>
      </div>
      <div class="">
      ...
      <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="faq" role="tabpanel" aria-labelledby="faq-tab">
          <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-800 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
              ...
              <div id="accordion-flush-body-1" class="" aria-labelledby="accordion-flush-heading-1">
                  ...
                  <p class="text-gray-500 dark:text-gray-400">dan nantinya di website TeamUp juga akan menyediakan list pekerjaan freelance yang diambil dari API website <a href="/docs/getting-started/introduction/" class="text-blue-600 dark:text-blue-500 hover:underline"> freelance.com</a> </p>
                  </div>
              </div>
...
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
  ...
  <div class="sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" class="hover:underline">TeamUp™</a>. All Rights Reserved.
      </span>
